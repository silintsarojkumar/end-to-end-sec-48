...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        This Function is responsalbe for data transformation
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            logging.info(
                f'Appling preprosing object on training dataframe and testing dataframe'
            )
            ...
            logging.info(f'Save preprossing object. ')
